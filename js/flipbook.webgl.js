...
*/
var MONTHVERSARRY = MONTHVERSARRY || {};

{ /* MONTHVERSARRY.PageWebGL */
    MONTHVERSARRY.PageWebGL = function(book, i, hard, options, preloaderMatF, preloaderMatB) {
        ...
        if (i == 0 && this.options.cornerCurl) {
            ...
            this.nfacesh = 20
             ...
             this.cornerCurlTween = new MONTHVERSARRY.TWEEN.Tween(0).to(1, 1000)
            .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.Out)
            .onUpdate(function(f) {
                if(self.cornerCurl){
                    self.b2.force = f * -1.8
                    self.modF.apply()
    ...
    MONTHVERSARRY.PageWebGL.prototype = new THREE.Object3D();
    MONTHVERSARRY.PageWebGL.prototype.constructor = MONTHVERSARRY.PageWebGL;

    MONTHVERSARRY.PageWebGL.prototype.startCornerCurl = function() {

        this.cornerCurl = true

    }

    MONTHVERSARRY.PageWebGL.prototype.stopCornerCurl = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.onPageCanvasLoaded = function(page, side, callback) {
        ...
        if (side == 'front' && this.sizeFront != page.size) {
            ...
            // MONTHVERSARRY.Buffer.addMaterial(self.backMaterial)
    ...
    MONTHVERSARRY.PageWebGL.prototype.load = function(side, callback) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.unload = function(side) {
    ...
    // MONTHVERSARRY.PageWebGL.prototype.reload = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.disposeMat = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.createMaterial = function(map, side) {
    ...
    MONTHVERSARRY.PageWebGL.prototype._setAngle = function(angle, direction) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.updateBend = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.flipLeft = function(onComplete) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.correctZOrder = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.flipLeftInstant = function(onComplete) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.hideMat = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.showMat = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.setFrontMat = function(m) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.setBackMat = function(m) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.flipRightInstant = function(onComplete) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.flipRight = function(onComplete) {
    ...
    MONTHVERSARRY.PageWebGL.prototype.bendIn = function(angle, newForce, newOffset) {
        ...
        new MONTHVERSARRY.TWEEN.Tween(this.to).to({
            ...
            .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.In)
    ...
    MONTHVERSARRY.PageWebGL.prototype.bendOut = function() {

        //tween bend.force to 0
        var self = this.thiss;
        var time = self.duration * Math.pow(Math.abs(self.bendF.force), .5) * 1000;
        new MONTHVERSARRY.TWEEN.Tween(self.bendF).to({
                force: 0,
                offset: 1
            }, time)
            .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.Out)
    ...
    MONTHVERSARRY.PageWebGL.prototype.modApply = function() {
    ...
    MONTHVERSARRY.PageWebGL.prototype.renderFlip = function() {
        this.thiss._setAngle(-this.angle * 180 / Math.PI)
    };
    MONTHVERSARRY.PageWebGL.prototype.flipFinished = function() {
        var self = this;
    ...
    MONTHVERSARRY.PageWebGL.prototype.isFlippedLeft = function() {

        return this.thiss.isFlippedLeft;

    };
    MONTHVERSARRY.PageWebGL.prototype.isFlippedRight = function() {

        return this.thiss.isFlippedRight;

    };

    MONTHVERSARRY.PageWebGL.prototype.positionZ = function() {

    }
}

{ /* MONTHVERSARRY.BookWebGL */
    MONTHVERSARRY.BookWebGL = function(el, model, options) {
    ...
    MONTHVERSARRY.BookWebGL.prototype = Object.create(MONTHVERSARRY.Book.prototype)

    MONTHVERSARRY.BookWebGL.prototype.constructor = MONTHVERSARRY.BookWebGL


    MONTHVERSARRY.BookWebGL.prototype.init3d = function() {
        // WebGL starts here
        var self = this,
            VIEW_ANGLE = 30,
...
*/
    ...
    MONTHVERSARRY.BookWebGL.prototype.onPageLoaded = function(index, size) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.onPageUnloaded = function(index, size) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.initHtmlContent = function() {
        ...
        this.htmlLayer = new MONTHVERSARRY.CSS3DObject(htmlLayer);
        //htmlObj.rotation.y = Math.PI/3

        this.Scene.add(this.htmlLayer);

        this.cssRenderer = new MONTHVERSARRY.CSS3DRenderer();
        var container = this.wrapper
    ...
    MONTHVERSARRY.BookWebGL.prototype.enablePrev = function(val) {
        this.prevEnabled = val
    }

    MONTHVERSARRY.BookWebGL.prototype.enableNext = function(val) {
        this.nextEnabled = val
    }

    MONTHVERSARRY.BookWebGL.prototype.isZoomed = function() {
        return this.options.zoom > this.options.zoomMin && this.options.zoom > 1
    }
    MONTHVERSARRY.BookWebGL.prototype.getRightPage = function() {
        return this.pages[this.flippedleft]
    }

    MONTHVERSARRY.BookWebGL.prototype.getNextPage = function() {
        return this.pages[this.flippedleft + 1]
    }

    MONTHVERSARRY.BookWebGL.prototype.getLeftPage = function() {
        return this.pages[this.flippedleft - 1]
    }

    MONTHVERSARRY.BookWebGL.prototype.getPrevPage = function() {
        return this.pages[this.flippedleft - 2]
    }

    MONTHVERSARRY.BookWebGL.prototype.onSwipe = function(event, phase, direction, distance, duration, fingerCount, fingerData) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.onResize = function() {
        var m = this.model,
            w = m.wrapperW,
            h = m.wrapperH,
            o = this.options,
    ...
    MONTHVERSARRY.BookWebGL.prototype.updateCameraPosition = function() {
        //tilt
    ...
    MONTHVERSARRY.BookWebGL.prototype.createPages = function() {
        //create all pages
        var self = this;
        ...
        for (i = 0; i < p.length / 2; i++) {
            ...
            page = new MONTHVERSARRY.PageWebGL(self, i, hardness, self.options, preloaderMatF, preloaderMatB);
    ...
    MONTHVERSARRY.BookWebGL.prototype.getNumPages = function() {
        return (this.pages.length);
    };

    MONTHVERSARRY.BookWebGL.prototype.centerContainer = function() {
        return (this.centerContainer);
    };

    MONTHVERSARRY.BookWebGL.prototype.goToPage = function(index, instant) { //index in book.pages, not page number
    ...
    MONTHVERSARRY.BookWebGL.prototype.nextPageInstant = function(load) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.setRightIndex = function(value) {
        ...
        MONTHVERSARRY.BookWebGL.prototype.prevPageInstant = function(load) {
            if (this.flippedleft == 0)
                return;
    ...
    MONTHVERSARRY.BookWebGL.prototype.nextPage = function(load) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.updateBookPosition = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.updateHtmlLayerPosition = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.turnPageComplete = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.loadVisiblePages = function(){
    ...
    MONTHVERSARRY.BookWebGL.prototype.focusLeft = function(time, delay) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.focusRight = function(time, delay) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.focusBoth = function(time, delay) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.moveToPos = function(pos, time, delay) {
        ...
        if (time && this.movingTo != pos && this.centerContainer.position.x != pos) {
            ...
            var self = this
            this.movingTo = pos
            var tween = new MONTHVERSARRY.TWEEN.Tween(this.centerContainer.position).to({
                    x: pos
                }, time)
                .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.Out)
                .onUpdate(function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.isFocusedLeft = function() {

        return this.centerContainer.position.x > 0

    };

    MONTHVERSARRY.BookWebGL.prototype.isFocusedRight = function() {

        return this.centerContainer.position.x < 0

    };

    MONTHVERSARRY.BookWebGL.prototype.prevPage = function(load) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.firstPage = function() {

    };

    MONTHVERSARRY.BookWebGL.prototype.flipFinnished = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.lastPage = function() {

    };

    MONTHVERSARRY.BookWebGL.prototype.updateVisiblePages = function() {

    };

    MONTHVERSARRY.BookWebGL.prototype.loadMorePages = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.updateHtmlLayer = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.updateTool = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.onZoom = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.render = function(rendering) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.zoomTo = function(amount, time, x, y) {
        ...
        if (time > 0) {
            if (!this.zooming) {
                ...
                new MONTHVERSARRY.TWEEN.Tween(this).to({
                        zoom: newZoom,
                    }, time)
                    .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.In)
                 ...
                 new MONTHVERSARRY.TWEEN.Tween(this.centerContainer.position).to({
                        x:newCenter.x,
                        y:newCenter.y
                    }, time)
                    .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.In)
                ...
                if(this.htmlLayer)
                    new MONTHVERSARRY.TWEEN.Tween(this.htmlLayer.position).to({
                        x:newCenter.x,
                        y:newCenter.y
                    }, time)
                    .easing(MONTHVERSARRY.TWEEN.Easing.Sinusoidal.In)
    ...
    MONTHVERSARRY.BookWebGL.prototype.tiltTo = function(amount) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.panTo = function(amount) {
    ...
    MONTHVERSARRY.BookWebGL.prototype._bind = function(type, el, bubble) {

        (el || this.wrapper).addEventListener(type, this, !!bubble);

    };

    MONTHVERSARRY.BookWebGL.prototype.handleEvent = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.resetCameraPosition = function() {

        this.centerContainer.position.set(0, 0, 0);

    };

    MONTHVERSARRY.BookWebGL.prototype._start = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype._touchstart = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype._getVector = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype._touchmove = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype._move = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype._end = function(e) {
    ...
    MONTHVERSARRY.BookWebGL.prototype.moveCamera = function(deltaX, deltaY) {

    };

    MONTHVERSARRY.BookWebGL.prototype.enable = function() {
    ...
    MONTHVERSARRY.BookWebGL.prototype.disable = function() {
        this.enabled = false;
        this.render(false);
    };
}
...

{
    ...
    MONTHVERSARRY.TWEEN = MONTHVERSARRY.TWEEN || (function() {
    ...
    MONTHVERSARRY.TWEEN.Tween = function(object) {
        ...
        var _delayTime = 0;
        var _startTime = null;
        var _easingFunction = MONTHVERSARRY.TWEEN.Easing.Linear.None;
        var _interpolationFunction = MONTHVERSARRY.TWEEN.Interpolation.Linear;
        var _chainedTweens = [];
        ...
        this.stop = function() {
            ...
            MONTHVERSARRY.TWEEN.remove(this);
            _isPlaying = false;
    ...
    MONTHVERSARRY.TWEEN.Easing = {
        ...
        Bounce: {
            ...
            In: function(k) {
                ...
                return 1 - MONTHVERSARRY.TWEEN.Easing.Bounce.Out(1 - k);
            ...
            InOut: function(k) {
                ...
                if (k < 0.5) return MONTHVERSARRY.TWEEN.Easing.Bounce.In(k * 2) * 0.5;
                return MONTHVERSARRY.TWEEN.Easing.Bounce.Out(k * 2 - 1) * 0.5 + 0.5;
    ...
    MONTHVERSARRY.TWEEN.Interpolation = {
        ...
        Linear: function(v, k) {
            ...
            var m = v.length - 1,
                f = m * k,
                i = Math.floor(f),
                fn = MONTHVERSARRY.TWEEN.Interpolation.Utils.Linear;
        ...
        Bezier: function(v, k) {
            ...
            var b = 0,
                n = v.length - 1,
                pw = Math.pow,
                bn = MONTHVERSARRY.TWEEN.Interpolation.Utils.Bernstein,
                i;
        ...
        CatmullRom: function(v, k) {
            ...
            var m = v.length - 1,
                f = m * k,
                i = Math.floor(f),
                fn = MONTHVERSARRY.TWEEN.Interpolation.Utils.CatmullRom;
        ...
        Utils: {
            ...
            Bernstein: function(n, i) {
                ...
                var fc = MONTHVERSARRY.TWEEN.Interpolation.Utils.Factorial;
...
MONTHVERSARRY.CSS3DObject = function ( element ) {
...
MONTHVERSARRY.CSS3DObject.prototype = Object.create( THREE.Object3D.prototype );
MONTHVERSARRY.CSS3DObject.prototype.constructor = MONTHVERSARRY.CSS3DObject;

MONTHVERSARRY.CSS3DSprite = function ( element ) {

    MONTHVERSARRY.CSS3DObject.call( this, element );

    this.type = "CSS3DSprite"

};

MONTHVERSARRY.CSS3DSprite.prototype = Object.create( MONTHVERSARRY.CSS3DObject.prototype );
MONTHVERSARRY.CSS3DSprite.prototype.constructor = MONTHVERSARRY.CSS3DSprite;

//

MONTHVERSARRY.CSS3DRenderer = function () {
    ...
    function renderObject( object, camera, cameraCSSMatrix ) {
        ...
        if ( object instanceof MONTHVERSARRY.CSS3DObject ) {
        // if ( object.type == "CSS3DObject" ) {

            var style;

            if ( object instanceof MONTHVERSARRY.CSS3DSprite ) {
    ...
    function filterAndFlatten( scene ) {
        ...
        scene.traverse( function ( object ) {
            ...
            if ( object instanceof MONTHVERSARRY.CSS3DObject ) result.push( object );
