...
! function (y, M, L, a) {
    y.fn.flipBook = function (e) {
        return new MONTHVERSARRY.Main(e, this)
    }, y.fn.swipeBook = function (e) {
        return e.viewMode = "swipe", new MONTHVERSARRY.Main(e, this)
    ...
    }, MONTHVERSARRY.Main = function (e, t) {
        var n = this;
        ...
        this.msie = M.navigator.userAgent.indexOf("MSIE "), this.isAndroid = l, this.has3d = d, void 0 === MONTHVERSARRY.hasWebGl && function (e) {
        ...
        function x() {
            var e, t, o;
            n.disposed || (e = M.location.hash, (o = t = n.getPageFromHash()) < 1 ? t = 1 : n.numPages && t > n.numPages && (t = n.numPages), t && (t = S.rightToLeft && S.pages && S.pages.length ? S.pages.length - t + 1 : t, n.started ? n.Book && (n.lightbox && !MONTHVERSARRY.lightboxOpened && (n.lightbox.openLightbox(), n.lightboxStart()), n.goToPage(t, -1 == e.indexOf("flip"))) : (S.startPage = o, S.lightBox && (O(), S.lightBoxFullscreen && setTimeout(function () {
                n.toggleExpand()
            }, 100)))))
        }
        ...
        }), this.model = P, S.lightBox ? (S.btnClose.enabled = !0, this.lightbox = new MONTHVERSARRY.Lightbox(this, this.wrapper, S), this.lightboxStartedTimes = 0, this.wrapper.css("background", "none"), this.bookLayer.css("background", "none"), this.book.css("background", "none"), this.preloader.appendTo(this.$body).css("position", "fixed"), this.$elem.css("cursor", "pointer").bind("tap click", function (e) {
        ...
        }), S.lightBoxOpened ? (O(), y(M).trigger("r3d-lightboxloadingstarted")) : S.lightboxPreload && ("undefined" != typeof IScroll || MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.iscrollSrc] || n.loadScript(MONTHVERSARRY.iscrollSrc, function () {}), void 0 !== MONTHVERSARRY.PdfService || MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.pdfServiceSrc] || n.loadScript(MONTHVERSARRY.pdfServiceSrc, function () {}), S.pdfMode && ("undefined" != typeof pdfjsLib || MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.pdfjsSrc] || n.loadScript(MONTHVERSARRY.pdfjsSrc, function () {}), void 0 !== MONTHVERSARRY.PdfService || MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.pdfServiceSrc] || n.loadScript(MONTHVERSARRY.pdfServiceSrc, function () {}), S.btnSearch.enabled && (MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.markSrc] || n.loadScript(MONTHVERSARRY.markSrc, function () {}))), "webgl" == S.viewMode && ("undefined" != typeof THREE || MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.threejsSrc] || n.loadScript(MONTHVERSARRY.threejsSrc, function () {}))), this.fullscreenElement = L.documentElement) : (S.btnClose.enabled = !1, this.preloader.appendTo(this.wrapper), this.wrapper.appendTo(this.$elem), this.fullscreenElement = this.$elem[0], O()))
    }, MONTHVERSARRY.Main.prototype = {
        start: function () {
        ...
        initPdf: function () {
            if (!this.started) {
                ...
                if ("undefined" == typeof pdfjsLib) {
                    if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.pdfjsSrc]) return void t.loadScript(MONTHVERSARRY.pdfjsSrc, function () {
                        t.initPdf()
                    });
                    if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.pdfjsSrc]) return void setTimeout(function () {
                        t.initPdf()
                    }, 100)
                }
                if (this.setLoadingProgress(.2), void 0 === MONTHVERSARRY.PdfService) {
                    if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.pdfServiceSrc]) return void t.loadScript(MONTHVERSARRY.pdfServiceSrc, function () {
                        t.initPdf()
                    });
                    if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.pdfServiceSrc]) return void setTimeout(function () {
                        t.initPdf()
                    }, 100)
                }
                ...
                }), PDFJS = pdfjsLib, pdfjsLib.externalLinkTarget = pdfjsLib.LinkTarget.BLANK, pdfjsLib.GlobalWorkerOptions.workerSrc = this.options.pdfjsworkerSrc || MONTHVERSARRY.pdfjsworkerSrc, "https:" == location.protocol ? t.options.pdfUrl = t.options.pdfUrl.replace("http://", "https://") : "http:" == location.protocol && (t.options.pdfUrl = t.options.pdfUrl.replace("https://", "http://"));
                var e = {
                    cMapPacked: !0,
                    cMapUrl: "cmaps/",
                    disableAutoFetch: !0,
                ...
                this.pdfinitStarted || (this.pdfinitStarted = !0, pdfjsLib.getDocument(e).promise.then(function (e) {
                    t.pdfDocument = e, t.pdfService = new MONTHVERSARRY.PdfService(e, t.model, t.options), t.options.thumbLoaded = function (e) {
        ...
        loadScript: function (o, i) {
            ...
            s.async = 1, e.parentNode.insertBefore(s, e), MONTHVERSARRY.scriptsAdded[o] = !0, s.onload = s.onreadystatechange = function (e, t) {
                !t && s.readyState && !/loaded|complete/.test(s.readyState) || (s.onload = s.onreadystatechange = null, s = a, t || i && i.call(n), MONTHVERSARRY.scriptsLoaded[o] = !0)
            }, s.src = o
        },
        createBook: function () {
            var e, n = this,
                t = this.model,
                o = this.options;
            if ("material" != o.icons || MONTHVERSARRY.MaterialIconsLoaded || (MONTHVERSARRY.MaterialIconsLoaded = !0, y("head").append('<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">')), "undefined" == typeof IScroll) {
                if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.iscrollSrc]) return void n.loadScript(MONTHVERSARRY.iscrollSrc, n.createBook);
                if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.iscrollSrc]) return void setTimeout(function () {
                    n.createBook()
                }, 100)
            }
            if (this.options.searchOnStart && (this.options.btnSearch.enabled = !0), this.options.btnSearch.enabled) {
                if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.markSrc]) return void n.loadScript(MONTHVERSARRY.markSrc, n.createBook);
                if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.markSrc]) return void setTimeout(function () {
                    n.createBook()
                }, 100)
            }
            if (n.setLoadingProgress(.9), "webgl" == n.options.viewMode) {
                if ("undefined" == typeof THREE) {
                    if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.threejsSrc]) return void n.loadScript(MONTHVERSARRY.threejsSrc, n.createBook);
                    if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.threejsSrc]) return void setTimeout(function () {
                        n.createBook()
                    }, 100)
                }
                if (void 0 === MONTHVERSARRY.BookWebGL) {
                    if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.flipbookWebGlSrc]) return void n.loadScript(MONTHVERSARRY.flipbookWebGlSrc, n.createBook);
                    if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.flipbookWebGlSrc]) return void setTimeout(function () {
                        n.createBook()
                    }, 100)
                }
            } else if ("swipe" == n.options.viewMode) {
                if (void 0 === MONTHVERSARRY.BookSwipe) {
                    if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.flipBookSwipeSrc]) return void n.loadScript(MONTHVERSARRY.flipBookSwipeSrc, n.createBook);
                    if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.flipBookSwipeSrc]) return void setTimeout(function () {
                        n.createBook()
                    }, 100)
                }
            } else if (void 0 === MONTHVERSARRY.Book3) {
                if (!MONTHVERSARRY.scriptsLoaded[MONTHVERSARRY.flipbookBook3Src]) return void n.loadScript(MONTHVERSARRY.flipbookBook3Src, n.createBook);
                if (!MONTHVERSARRY.scriptsAdded[MONTHVERSARRY.flipbookBook3Src]) return void setTimeout(function () {
                    n.createBook()
                }, 100)
            }
            ...
            "webgl" == n.options.viewMode ? ((e = n.options).scroll = n.scroll, (e.parent = n).Book = new MONTHVERSARRY.BookWebGL(n.book[0], t, e), n.webglMode = !0, n.initSwipe(), d()) : "swipe" == n.options.viewMode ? (n.Book = new MONTHVERSARRY.BookSwipe(n.book[0], n.bookLayer[0], t, o), n.initSwipe()) : ("2d" != n.options.viewMode && (n.options.viewMode = "3d"), n.Book = new MONTHVERSARRY.Book3(n.book[0], t, o), n.initSwipe(), n.webglMode = !1, d()), this.resize(), n.Book.enable(), n.book.hide().fadeIn("slow"), this.tocCreated = !1, this.createMenu(), this.onZoom(this.options.zoom), 1 == this.options.pages.length && (this.rightToLeft = !1), MONTHVERSARRY.books = MONTHVERSARRY.books || {}, MONTHVERSARRY.books[n.id] = n.Book;
            var h = y(n.Book);
        ...
        onBookCreated: function () {
            ...
            e.rightToLeft ? t.goToPage(Number(e.pages.length - Number(e.startPage) + 1), !0) : t.goToPage(Number(e.startPage), !0), y(M).resize(function () {
                ...
                t.Book.enabled && MONTHVERSARRY.lightboxOpened && (M.location.hash || t.lightbox.closeLightbox(!0))
        ...
        createToc: function () {
            ...
            if (e && e.length || !this.pdfService || this.pdfService.outlineLoaded) {
                if (this.tocHolder = y("<div>").addClass("flipbook-tocHolder flipbook-side-menu skin-color-bg").appendTo(this.wrapper).css(this.options.sideMenuPosition, "0").hide(), this.createMenuHeader(this.tocHolder, this.strings.tableOfContent, this.toggleToc), this.toc = y("<div>").addClass("flipbook-toc").appendTo(this.tocHolder), this.tocScroller = y("<div>").addClass("flipbook-toc-scroller").appendTo(this.toc), this.tocScroll = new MONTHVERSARRY.IScroll(i.toc[0], {
                        bounce: !1,
                        mouseWheel: !0,
                        scrollbars: !0,
        ...
        createThumbs: function () {
            this.thumbs = new MONTHVERSARRY.Thumbnails(this)
        },
    ...
    }, MONTHVERSARRY.Book = function () {}, MONTHVERSARRY.Book.prototype = {
        rightIndex: 0,
        goToPage: function () {},
    ...
    }, MONTHVERSARRY.Thumbnails = function (o) {
        var a = this,
            i = o.options,
            e = o.wrapper;
        ...
        this.thumbScroll = new MONTHVERSARRY.IScroll(this.thumbsWrapper[0], {
            bounce: !1,
            mouseWheel: !0,
            scrollbars: !0,
            interactiveScrollbars: !0
        }), o.initColors()
    }, MONTHVERSARRY.Thumbnails.prototype = {
    ...
    }, MONTHVERSARRY.Lightbox = function (e, t, o) {
        var i = this;
        ...
        return ""
    }, MONTHVERSARRY.flipbookSrc = MONTHVERSARRY.getFlipbookSrc(), MONTHVERSARRY.iscrollSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/iscroll."), MONTHVERSARRY.threejsSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/three."), MONTHVERSARRY.flipbookWebGlSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/flipbook.webgl."), MONTHVERSARRY.flipbookBook3Src = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/flipbook.book3."), MONTHVERSARRY.flipBookSwipeSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/flipbook.swipe."), MONTHVERSARRY.pdfjsSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/pdf."), MONTHVERSARRY.pdfServiceSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/flipbook.pdfservice."), MONTHVERSARRY.pdfjsworkerSrc = MONTHVERSARRY.flipbookSrc.replace("/flipbook.", "/pdf.worker."), MONTHVERSARRY.markSrc = "https://cdnjs.cloudflare.com/ajax/libs/mark.js/8.11.1/jquery.mark.js", MONTHVERSARRY.scriptsLoaded = {}, MONTHVERSARRY.scriptsAdded = {}
}(jQuery, window, document), MONTHVERSARRY.onPageLinkClick = function (e) {
        var t = e.dataset.bookid,
            o = e.dataset.page;
        o && MONTHVERSARRY.books[t].goToPage(Number(o));
        var i = e.dataset.url;
